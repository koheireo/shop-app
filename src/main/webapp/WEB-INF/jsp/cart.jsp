    ...
    <main>
        ...
        <div class="item-wrapper detail">
        	...
        	<%for(Cart c:list) {%>
	            <div class="cart">
	                <div class="info">
	                    <img src="upload/<%=c.getImages_pass() %>" alt=""
	                        width="100px" height="100px">
	                    <ul>
	                        <li><span>商品名：</span><span><%=c.getProduct_name() %></span></li>
	                        <li><span>価格：</span><span><%=c.getProduct_price() %></span></li>
	                        <li><span>登録日：</span><span><%=c.getEntry_date()%></span></li>
	                    </ul>
