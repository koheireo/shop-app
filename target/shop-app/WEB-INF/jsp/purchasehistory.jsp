...
<%
	...
	List<SalesHistory> list = (List<SalesHistory>)request.getAttribute("list");
%>
<!DOCTYPE html>
<html lang="ja">
...
<body>
    ...
    <main>
        ...
        <div class="item-wrapper detail">
        	...
        	<%for(SalesHistory s:list) {%>
	            <div class="cart">
	                <div class="info">
	                    <img src="upload/<%=s.getImages_pass() %>" alt=""
	                        width="100px" height="100px">
	                    <ul>
	                        <li><span>商品名：</span><span><%=s.getProduct_name() %></span></li>
	                        <li><span>価格：</span><span><%=s.getProduct_price() %></span></li>
	                        <li><span>個数：</span><span><%=s.getQuantity() %></span></li>
	                        <li><span>お届け予定日：</span><span><%=s.getDelivery_date() %></span></li>
	                    </ul>
